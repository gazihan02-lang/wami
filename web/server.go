...
func (s *Server) routes() {
	...
	s.mux.HandleFunc("POST /destek/create", s.handleTicketCreate)
	s.mux.HandleFunc("POST /destek/reply", s.handleTicketReply)
	s.mux.HandleFunc("POST /destek/delete", s.handleTicketDelete)
